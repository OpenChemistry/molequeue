                                       ...
                                       IdType packetId)
{
  ...
  Json::Value paramsObject = QtJson::qtToJson(job.hash());
                                              ...
                                              IdType packetId)
{
  ...
  if (!req.isValid()) {
    ...
    packet["result"] = QtJson::qtToJson(req.hash());
  }
                                     ...
                                     const Json::Value &root) const
{
  ...
  QVariantHash optionHash = QtJson::jsonToQt(paramsObject).toHash();
...
void JsonRpc::handleLookupJobResult(const Json::Value &root) const
{
  ...
  QVariantHash hash = QtJson::jsonToQt(resultObject).toHash();
