                                           ...
                                           const QModelIndex &index) const
{
  if (index.column() == OpenWithPatternModel::PatternTypeCol) {
    ...
    combo->setModel(this->patternTypeModel());
    return combo;
  }

  return this->QItemDelegate::createEditor(parentWidget, option, index);
}

void PatternTypeDelegate::updateEditorGeometry(
    ...
    const QModelIndex &index) const
{
  ...
  this->QItemDelegate::updateEditorGeometry(editor, option, index);
}
