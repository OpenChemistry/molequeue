    ...
    m_errorCount(0)
{
  ...
  connect(m_ui->errorNotifLabel, SIGNAL(linkActivated(QString)),
          this, SLOT(handleErrorNotifLabelAction(QString)));
...
void MainWindow::handleErrorNotifLabelAction(const QString &action)
{
  if (action == "viewLog")
    showLogWindow();
